# IIWA Robot Manipulator - ROS 2 Control Packages

ROS 2 Humble packages for controlling the KUKA IIWA robot manipulator with KDL-based control, vision-based servoing, and ArUco marker detection in Gazebo simulation.
